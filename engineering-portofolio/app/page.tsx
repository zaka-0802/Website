...
import ThreeJsRainBackground from "@/components/three-js-rain-background" // Import the new Three.js background
...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen bg-gray-900 px-4 py-10 sm:px-10 md:px-20">
      {/* Animated Background */}
      <ThreeJsRainBackground /> {/* Use the new Three.js background */}
      {/* Music Player */}
      <MusicPlayer />
